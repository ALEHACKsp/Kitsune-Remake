...
#if RELEASE
#if BETA
#define VERSION crypt_str("lean.club [beta] | ")
#else
#define VERSION crypt_str("lean.club | ")
#endif
#else
#define VERSION crypt_str("lean.club [alpha] | ")
#endif
int pre_flags = 0;
...
void misc::ChatSpamer()
{
	...
	{ 
		crypt_str("lean.club - 2021"),
		crypt_str("get good. get lean.club."),
		crypt_str("lean.club - just the best"),
		crypt_str("owo"),
	};
