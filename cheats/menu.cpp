...
std::string get_config_dir()
{
	...
	if (SUCCEEDED(SHGetFolderPath(NULL, 0x001a, NULL, NULL, path)))
		folder = std::string(path) + crypt_str("\\lean.club\\Configs\\");
...
void lua_edit(std::string window_name)
{
	...
	auto get_dir = [&]() -> void
	{
		...
		if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, NULL, path)))
			file_path = std::string(path) + crypt_str("\\lean.club\\Scripts\\");
...
// IMPORTANT: DO TAB SWITCHING BY LAST_TAB!!!!!
	...
	if (ImGui::Begin(crypt_str("lean.club v1337"), nullptr, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoScrollbar))
	{
		...
		ImGui::BeginChild("##Full", ImVec2{ 720, 560 }, false);
		{
			...
			ImGui::BeginChild("##Up", ImVec2{ 720, 50 }, false);
			{
				...
				ImGui::PushFont(c_menu::get().futura_large); ImGui::TextColored(ImColor(255, 255, 255), "lean.club"); ImGui::PopFont();
				
				#if BETA
				ImGui::SetCursorPos(ImVec2{ 90, 25 });
				ImGui::PushFont(c_menu::get().futura); ImGui::TextColored(ImColor(255, 255, 255), "Pre-Release"); ImGui::PopFont();
				#endif
						...
						ImGui::BeginGroup();
						{
								...
								if (ImGui::CustomButton(crypt_str("Open scripts folder"), crypt_str("##LUAS__FOLDER"), ImVec2(220 * dpi_scale, 26 * dpi_scale)))
								{
									...
									auto get_dir = [&folder]() -> void
									{
										...
										if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, NULL, path)))
											folder = std::string(path) + crypt_str("\\lean.club\\Scripts\\");
...
void c_menu::create_style()
{
	...
	_style.Colors[ImGuiCol_::ImGuiCol_Header] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_HeaderHovered] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_HeaderActive] = ImColor(167, 144, 244, 255);
	_style.Colors[ImGuiCol_::ImGuiCol_TitleBg] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_TitleBgActive] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_TitleBgCollapsed] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_WindowBg] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_ChildWindowBg] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_ChildBg] = ImColor(167, 144, 244, 180);
	_style.Colors[ImGuiCol_::ImGuiCol_Border] = ImVec4(167, 144, 244, 180);
	_style.Colors[ImGuiCol_FrameBg] = ImVec4(167, 144, 244, 180);
	_style.Colors[ImGuiCol_FrameBgActive] = ImVec4(167, 144, 244, 180);
	_style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(167, 144, 244, 180);
